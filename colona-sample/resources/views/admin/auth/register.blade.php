    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            ...
            <form method="POST" action="{{ route('admin.create') }}">
                ...
                <div class="form-group row">
                <label for="troupes" class="col-md-5 col-form-label text-md-left">劇団名<span class="ml-1 samazon-require-input-label"><span class="samazon-require-input-label-text">必須</span></span></label>
